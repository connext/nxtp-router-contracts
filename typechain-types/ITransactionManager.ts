...
export type TransactionCancelledEvent = TypedEvent<
  [string, string, string, CancelArgsStructOutput, string],
  {
    user: string;
    router: string;
    transactionId: string;
    args: CancelArgsStructOutput;
    caller: string;
  }
>;
